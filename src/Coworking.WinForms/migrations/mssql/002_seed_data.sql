...
('Basic',       2000.00, 30,  40, 0,  0),
('Premium',     5000.00, 30,  80, 0,  0),
('Gold',       10000.00, 30, 160, 0,  0),
...
-- Resursi - Sale (resurs_id 1-4)
INSERT INTO resurs (oznaka, tip_resursa, opis, lokacija_id) VALUES
('Sala A',   'sala', 'Velika konferencijska sala',  1),
('Sala B',   'sala', 'Srednja sala za sastanke',    1),
('Sala C',   'sala', 'Mala sala za intervjue',      1),
('VIP Sala', 'sala', 'Premium sala sa svom opremom', 2)
GO
...
-- Resursi - Radna mesta (resurs_id 5-10)
INSERT INTO resurs (oznaka, tip_resursa, opis, lokacija_id) VALUES
('Hot Desk 1',       'radno_mesto', 'Fleksibilno radno mesto - zona A', 1),
('Hot Desk 2',       'radno_mesto', 'Fleksibilno radno mesto - zona A', 1),
('Hot Desk 3',       'radno_mesto', 'Fleksibilno radno mesto - zona B', 1),
('Dedicated Desk 1', 'radno_mesto', 'Fiksno radno mesto - zona C',      1),
('Dedicated Desk 2', 'radno_mesto', 'Fiksno radno mesto - zona C',      1),
('Private Office 1', 'radno_mesto', 'Privatna kancelarija',             2)
GO
...
('2025-02-16 14:00:00', '2025-02-16 16:00:00', 'Zavrsena',    2, 1),
('2025-02-16 09:00:00', '2025-02-16 17:00:00', 'Zavrsena',    3, 5),
