...
DROP TRIGGER IF EXISTS clan_insert_trigger;

CREATE TRIGGER clan_insert_trigger
AFTER INSERT ON clan
FOR EACH ROW
INSERT INTO change_log(entity_name, change_time)
VALUES ('Clan', NOW());

DROP TRIGGER IF EXISTS lokacije_insert_trigger;

CREATE TRIGGER lokacije_insert_trigger
AFTER INSERT ON lokacija
FOR EACH ROW
INSERT INTO change_log(entity_name, change_time)
VALUES ('Lokacija', NOW());

DROP TRIGGER IF EXISTS resurs_insert_trigger;

CREATE TRIGGER resurs_insert_trigger
AFTER INSERT ON resurs
FOR EACH ROW
INSERT INTO change_log(entity_name, change_time)
VALUES ('Resurs', NOW());

DROP TRIGGER IF EXISTS radno_mesto_insert_trigger;

CREATE TRIGGER radno_mesto_insert_trigger
AFTER INSERT ON radno_mesto_detalj
FOR EACH ROW
INSERT INTO change_log(entity_name, change_time)
VALUES ('Resurs', NOW());

DROP TRIGGER IF EXISTS sala_za_sastanke_insert_trigger;

CREATE TRIGGER sala_za_sastanke_insert_trigger
AFTER INSERT ON sala_detalj
FOR EACH ROW
INSERT INTO change_log(entity_name, change_time)
VALUES ('Resurs', NOW());

DROP TRIGGER IF EXISTS rezervacija_insert_trigger;

CREATE TRIGGER rezervacija_insert_trigger
AFTER INSERT ON rezervacija
FOR EACH ROW
INSERT INTO change_log(entity_name, change_time)
VALUES ('Rezervacija', NOW());

DROP TRIGGER IF EXISTS tip_clanstva_insert_trigger;

CREATE TRIGGER tip_clanstva_insert_trigger
...
DROP TRIGGER IF EXISTS lokacije_update_trigger;

CREATE TRIGGER lokacije_update_trigger
...
DROP TRIGGER IF EXISTS sala_za_sastanke_update_trigger;

CREATE TRIGGER sala_za_sastanke_update_trigger
